{{-- <nav class="bg-gray-800 h-35">
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <!-- First Row: Logos -->
        <div class="relative flex h-full items-center justify-between">
            <!-- Left Logo -->
            <div
                class="flex items-center justify-center sm:items-stretch sm:justify-start hover:scale-150 transition-transform duration-300 ease-in-out">
            ...
            <!-- Center Menu Button for Mobile -->
            <div class="block lg:hidden flex items-center justify-center absolute inset-x-0">
            ...
            <!-- Right Logo -->
            <div class="flex items-center pr-2 hover:scale-150 transition-transform duration-300 ease-in-out">
                <div class="relative ml-3">
                    <div class="flex items-center rounded-full">
                        <div class="flex flex-shrink-0 items-center">
                            <img class="h-5 md:h-10 w-auto" src="{{ asset('assets/images/loho_white.png') }}"
                                alt="Artsell">
                        </div>
                    </div>
                </div>
        ...
        <!-- Second Row: Static Links with Collapsible Feature -->
        <div class="relative">
            <!-- Desktop Links -->
...
<nav class="bg-gradient-animated h-34">
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        ...
        <div class="relative flex h-full items-center justify-between">
            ...
            <!-- Right Logo -->
            <div
                class="flex items-center pr-2 hover:scale-150 transition-transform duration-300 ease-in-out animate-logo">
                <div class="relative ml-3">
                    <div class="flex items-center rounded-full">
                        <div class="flex flex-shrink-0 items-center">
                            <img class="h-5 md:h-10 w-auto" src="{{ asset('assets/images/loho_white.png') }}"
